...
if ('/opt/cpanel/ea-php73/root/usr/share/pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/opt/cpanel/ea-php73/root/usr/share/pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
